      ...
      <main>
            ...
            <div className="mx-auto max-w-5xl lg:max-w-6xl xl:max-w-7xl">
              ...
              >
                ...
                >
                  {buildItems.map((item) => (
                    <span
                      key={item}
                      className="tracking-widest font-semibold bg-clip-text text-transparent bg-gradient-to-br from-primary to-sky-500"
                    >
                      {item}
                    </span>
                  ))}
              ...
              >
                <div className="border-border/40 bg-background/50 rounded-xl border shadow-xl backdrop-blur-sm">
                  ...
                  <div className="from-background absolute inset-0 bg-gradient-to-t to-transparent opacity-0 pointer-events-none"></div>
                </div>
        ...
        >
          <div className="flex flex-col items-center justify-center gap-8">
            ...
            <div className="absolute inset-0 mx-auto h-44 max-w-xs blur-[118px] bg-gradient-to-b from-primary/20 to-transparent"></div>
